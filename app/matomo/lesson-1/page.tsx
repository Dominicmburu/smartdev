...
export default function MatomoLesson1Page() {
  return (
    <article className="lesson-content">
      ...
      <Example title="the simplest use case">
        <p>
      ...
      <Example title="tracking where visitors come from">
        <p>
      ...
      <Example title="following a single visitor's path (without knowing who they are personally)">
        <p>
